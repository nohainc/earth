...
test('Database Backup, Migration Preflight, and Checksum Verification', async () => {
  ...
  for (const file of files) {
    ...
    assert.ok(
      content.includes('CREATE') || content.includes('ALTER') || content.includes('INSERT') || content.includes('UPDATE') || content.includes('DELETE') || content.includes('DROP') || content.includes('COMMENT') || content.includes('DO $$') || content.includes('DO\n$$') || content.includes('SELECT'),

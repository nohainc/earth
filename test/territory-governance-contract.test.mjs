...
test('Territory governance is explicit, historical, and independent of capacity state', () => {
  ...
  assert.match(source, /governing_institution_id/);
  assert.match(source, /governing_institution_name/);
  assert.match(source, /territory_governance/);

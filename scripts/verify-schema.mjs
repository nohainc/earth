...
if (migrationNames.length < 83) failures.push(`expected at least 83 migrations, found ${migrationNames.length}`);
if (manifest.migrationVersion !== 83) failures.push(`expected schema manifest version 83, found ${manifest.migrationVersion}`);

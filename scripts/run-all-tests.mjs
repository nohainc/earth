...
async function main() {
  ...
  // Step 2: The full Flutter suite is authoritative for CI and release
  // health. A smaller smoke suite remains available as test:flutter:smoke.
  await runStep('2. Full Flutter Test Suite', 'flutter', ['test'], flutterDir);

...
export const API_ROUTES: readonly ApiRouteContract[] = [
  ...
  { method: 'GET', path: '/api/telemetry/errors', owner: 'SystemRoutes', auth: 'INTERNAL_ADMIN', service: 'listRecentAppErrors', status: 'ACTIVE' },
  { method: 'POST', path: '/api/telemetry/error', owner: 'SystemRoutes', auth: 'AUTHENTICATED', service: 'logAppError', status: 'ACTIVE' },
];

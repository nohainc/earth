...
export const BUILDING_CATALOG: Record<string, BuildingCatalogItem> = {
  ...
  'transit-terminus': {
    ...
    dailyEnergyUpkeep: 2.0,
    dailyFoodUpkeep: 0,
    dailyMaterialsUpkeep: 0.2,
    dailyComponentsUpkeep: 0.2,
    dailyComputeUpkeep: 0,
    dailyStaffingCredits: 260,
    dailyCreditRevenue: 0,
    resourceOutputType: 'credits',
    resourceOutputAmount: 0,
    estimatedPaybackDays: 0,
    resourceSensitivity: 'medium',
    maintenanceRisk: 'medium',
    primaryEconomicPurpose: 'Municipal Transit and District Connectivity',
    civicBenefit: 'Connects city districts and improves civic mobility.',
    description: 'City-owned transit interchange for reliable movement between districts.',
    tiers: [{
      tier: 1,
      name: 'Local Transit Interchange',
      upgradeCreditCost: 0,
      upgradeMaterialCost: 0,
      dailyCreditRevenue: 0,
      dailyOperatingCredits: 260,
      dailyEnergyUpkeep: 2.0,
      unlockedPerks: ['District Transit Links'],
      description: 'Standard municipal transit hub.',
    }],
  },
  'urban-district-module': {
    type: 'urban-district-module',
    name: 'Urban District Module',
    category: 'civic',
    slotFootprint: 0,
    defaultOwnershipClass: 'civic',
    tier: 1,
    baseCreditCost: 50000,
    baseMaterialCost: 1000,
    dailyEnergyUpkeep: 10.0,
    dailyFoodUpkeep: 0,
    dailyMaterialsUpkeep: 0.5,
    dailyComponentsUpkeep: 0.5,
    dailyComputeUpkeep: 0,
    ...
    tiers: [{
      ...
      upgradeMaterialCost: 0,
      dailyCreditRevenue: 0,
      dailyOperatingCredits: 100,
      dailyEnergyUpkeep: 10.0,
      unlockedPerks: ['+10 Citizen Capacity', '+120 Total Slots'],
      description: 'Standard horizontal sector expansion module.',
    }],
  },
  'private-estate-plot': {
    type: 'private-estate-plot',
    ...
    baseCreditCost: 0,
    baseMaterialCost: 0,
    dailyEnergyUpkeep: 1.0,
    dailyFoodUpkeep: 1.0,
    dailyMaterialsUpkeep: 0,
    dailyComponentsUpkeep: 0,
    dailyComputeUpkeep: 0.25,
    dailyStaffingCredits: 10,
    dailyCreditRevenue: 0,
    resourceOutputType: 'credits',
    resourceOutputAmount: 0,
    estimatedPaybackDays: 0,
    resourceSensitivity: 'low',
    maintenanceRisk: 'low',
    primaryEconomicPurpose: 'Residential Domicile, Life Sustenance & 3D Vertical Estate Capacity',
    description: 'Personal residential deed, domicile shelter, and vertical arcology foundation.',
    tiers: [
      {
        tier: 1,
        name: 'Private Estate Plot',
        ...
        upgradeMaterialCost: 0,
        dailyCreditRevenue: 0,
        dailyOperatingCredits: 10,
        dailyEnergyUpkeep: 1.0,
        dailyFoodUpkeep: 1.0,
        dailyComputeUpkeep: 0.25,
        unlockedPerks: ['10 Private Building Slots', 'Basic Life & Domicile Support'],
        description: 'Standard residential ground plot and shelter granted to every citizen.',
      },
      {
        tier: 2,
        name: 'Mezzanine Estate Deck',
        upgradeCreditCost: 25000,
        upgradeMaterialCost: 500,
        dailyCreditRevenue: 0,
        dailyOperatingCredits: 50,
        dailyEnergyUpkeep: 1.5,
        dailyFoodUpkeep: 1.2,
        dailyComputeUpkeep: 0.5,
        unlockedPerks: ['20 Private Building Slots', 'Enhanced Urban Living'],
        description: 'First vertical tier expansion supporting larger enterprise footprints and upgraded residence.',
      },
      {
        tier: 3,
        name: 'High-Rise Arcology Strata',
        upgradeCreditCost: 100000,
        upgradeMaterialCost: 1500,
        upgradeComponentsCost: 2500,
        dailyCreditRevenue: 0,
        dailyOperatingCredits: 200,
        dailyEnergyUpkeep: 4.0,
        dailyFoodUpkeep: 1.5,
        dailyComputeUpkeep: 1.0,
        unlockedPerks: ['30 Private Building Slots', 'High-Rise Luxury Quarters'],
        description: 'Advanced vertical spire framework for industrial conglomerates and luxury domicile.',
      },
      {
        tier: 4,
        name: 'Orbital Spire Apex',
        upgradeCreditCost: 500000,
        upgradeMaterialCost: 5000,
        upgradeComponentsCost: 10000,
        upgradeComputeCost: 500,
        dailyCreditRevenue: 0,
        dailyOperatingCredits: 800,
        dailyEnergyUpkeep: 10.0,
        dailyFoodUpkeep: 2.0,
        dailyComputeUpkeep: 2.5,
        unlockedPerks: ['40 Private Building Slots', 'Planetary Spire Penthouse'],
        description: 'Atmospheric apex deck supporting planetary-scale operations and elite domicile.',
      },
    ],
  },
};

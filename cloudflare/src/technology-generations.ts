...
export function evaluateGeneration(input: { generationId: string; minimumGameDay: number; currentGameDay: number; predecessorId?: string | null; predecessorDiscovered: boolean }): GenerationState {

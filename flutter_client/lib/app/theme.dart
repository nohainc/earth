...
enum EarthThemeMode {
  zenithCyan(
    ...
    description: 'High-clarity tactical cybernetic palette with ice-cyan primary & deep space canvas.',
  ...
  solarGold(
    ...
    description: 'Imperial solar gold accents for prestigious dynasties and high-stakes finance.',
  ...
  matrixAmber(
    ...
    description: 'Retro-futuristic tactical terminal palette with CRT phosphor amber radiance.',
  ...
  orbitalViolet(
    ...
    description: 'Hyper-advanced deep violet and electric purple synthwave void.',
  ...
  midnightEmerald(
    ...
    description: 'Biotech vertical farm and hydroponic energy aesthetic with emerald luster.',
...
ThemeData createEarthTheme([EarthThemeMode mode = EarthThemeMode.zenithCyan]) => ThemeData(

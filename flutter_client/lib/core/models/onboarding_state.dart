...
class OnboardingStep {
  ...
  static const List<OnboardingStep> steps = [
    ...
    OnboardingStep(
      ...
      subtitle: 'Territory Context & Civic Residency',
      description: 'Review Territory residency, Corporation affiliation, and the physical capacity conditions that shape civic life.',
      actionLabel: 'VIEW CIVIC CONDITIONS',
      targetSection: 'civic',
      icon: Icons.public_outlined,
    ),
    OnboardingStep(
    ...
    OnboardingStep(
      ...
      actionLabel: 'CHECK ACTIVITY & CHANNELS',

...
import '../command_center/theme_customizer_dialog.dart';
...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final citizenName =
        (human['display_name'] ?? human['name'] ?? 'Citizen').toString();
    final citizenId = human['id']?.toString() ?? 'UNAVAILABLE';
    ...
    return Column(
      ...
      children: [
        ...
        // 3. Audio & Visual Preferences Card
        _buildCard(
          context,
          title: 'AUDIO & DISPLAY PREFERENCES',
            ...
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Customize color modes, contrast, and visual density.',
                          style: TextStyle(
                            color: context.mutedColor,
                            fontSize: 11.5,
                          ),
                  ...
                  FilledButton.tonalIcon(
                    ...
                    onPressed: () => showThemeCustomizerDialog(context),
                  ),
                ],
              ),
              const SizedBox(height: 16),
              ...
              Row(
                children: [
                  ...
                  Switch(
                    value: !EarthAudioEngine.instance.isMuted,
                    onChanged: (enabled) {
                      setState(() {
                        EarthAudioEngine.instance.setMuted(!enabled);
                      });
                      if (enabled) EarthAudioEngine.instance.playClick();
                    },
                  ),
                ],
              ),
              if (!EarthAudioEngine.instance.isMuted) ...[
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Slider(
                        value: EarthAudioEngine.instance.sfxVolume,
                        min: 0.0,
                        max: 1.0,
                        onChanged: (val) {
                          setState(() {
                            EarthAudioEngine.instance.setSfxVolume(val);
                          });
                        },
                        onChangeEnd: (_) =>
                            EarthAudioEngine.instance.playClick(),
                    ...
                    Text(
                      '${(EarthAudioEngine.instance.sfxVolume * 100).toInt()}%',
                      style: TextStyle(
                        color: context.inkColor,
                        fontSize: 11,

  ...
  Widget build(BuildContext context) {
    ...
    return EarthSection(
      ...
      infoBulletPoints: const [
        ...
        'Direction Tracks: Enterprise (profitable businesses), Civic (territory laws & capacity), House (family succession), Technology (research and capabilities), Finance (solvency and independence).',

...
void showOnboardingWelcomeDialog(BuildContext context) {
  showDialog(
    context: context,
    builder: (context) => const OnboardingWelcomeDialog(),
  );
}

class OnboardingWelcomeDialog extends StatelessWidget {
  const OnboardingWelcomeDialog({super.key});
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Icon(Icons.stars_rounded, color: EarthThemeController.instance.primaryAccent, size: 22),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          'WELCOME TO EARTH: UNITED CORPORATIONS',
                          style: TextStyle(
                        ...
                        const Text(
                          'First-Session Operational Protocol • Year 2148 Planetary Federation',
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...steps.map((s) => _buildStepPreviewCard(s)),
                  ],
                ),
              ),
            ),
              ...
              child: Row(
                ...
                children: [
                  TextButton(
                    ...
                    child: const Text('DISMISS & EXPLORE FREELY', style: TextStyle(color: EarthColors.textMuted, fontSize: 11)),
                  ),
                  FilledButton.icon(
  ...
  Widget _buildStepPreviewCard(OnboardingStep step) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 12),
          Icon(step.icon, color: EarthThemeController.instance.primaryAccent, size: 18),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  step.subtitle,
                  style: TextStyle(color: EarthThemeController.instance.primaryAccent, fontSize: 10),
                ),
              ],
            ),
          ),

...
void main() {
  testWidgets('Tier 2 dynasty page golden', (tester) async {
    tester.view.physicalSize = const Size(1440, 900);
    tester.view.devicePixelRatio = 1;
    addTearDown(tester.view.resetPhysicalSize);
    final client = MockClient((_) async => http.Response(NanoMarkupHelper.encode({
      'dynasty': {'id': 'DYN-01', 'dynasty_name': 'House Vance', 'motto': 'From memory we build', 'legacy_points': 350, 'total_wealth_generated': 450000},
    ...
    await tester.pumpWidget(MaterialApp(theme: createEarthTheme(), home: Scaffold(body: DynastyTreeDialog(api: api))));
    await tester.pumpAndSettle();
    await expectLater(find.byType(MaterialApp), matchesGoldenFile('goldens/qa/dynasty_1440.png'));
  });
}

...
The former pre-V4 page integration suites are retained separately as `npm run test:pages:legacy`; they target removed tables and APIs and are not release gates.

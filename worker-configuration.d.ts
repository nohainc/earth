/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.api.jsonc` (hash: 0862fad03a528091d4a2b654ca222075)
...
interface __BaseEnv_Env {
	...
	MARKET_COORDINATOR: DurableObjectNamespace<import("./cloudflare/src/index").MarketCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/src/index");
		durableNamespaces: "MarketCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PERSISTENCE_AUTHORITY" | "EMAIL_FROM" | "DATABASE_URL" | "HYPERDRIVE_CONNECTION_STRING" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE">> {}
}

...
VALUES
  ('EARTH.GOVERNANCE.POLICY_QUORUM_BPS', 'EARTH_GOVERNANCE', 'RATE_BPS', 'EARTH_LOCKED', 'EARTH_GOVERNANCE_POLICY', 'earth.governance.policy_quorum_bps', 'POLICY', '[]'),
  ('EARTH.GOVERNANCE.POLICY_APPROVAL_BPS', 'EARTH_GOVERNANCE', 'RATE_BPS', 'EARTH_LOCKED', 'EARTH_GOVERNANCE_POLICY', 'earth.governance.policy_approval_bps', 'POLICY', '[]'),
  ('EARTH.GOVERNANCE.VOTING_PERIOD_DAYS', 'EARTH_GOVERNANCE', 'GAME_DAYS', 'EARTH_LOCKED', 'EARTH_GOVERNANCE_POLICY', 'earth.governance.voting_period_days', 'POLICY', '[]'),
  ('EARTH.GOVERNANCE.IMPLEMENTATION_DELAY_DAYS', 'EARTH_GOVERNANCE', 'GAME_DAYS', 'EARTH_LOCKED', 'EARTH_GOVERNANCE_POLICY', 'earth.governance.implementation_delay_days', 'POLICY', '[]')
